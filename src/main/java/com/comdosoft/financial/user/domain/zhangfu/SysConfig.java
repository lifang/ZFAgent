...
public class SysConfig {
     ...
     * 交易流水默认分润比例
     */
    public static final String PARAMNAME_TRADERECORDDEFAULTPROFIT = "tradeRecordDefaultProfit";
    
    /**
     * 租金默认分润比例
     */
    public static final String PARAMNAME_HIREDEFAULTPROFIT = "hireDefaultProfit";
