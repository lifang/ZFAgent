package com.comdosoft.financial.user.utils.alipay.util;
...
import com.comdosoft.financial.user.utils.alipay.config.AlipayConfig;
import com.comdosoft.financial.user.utils.alipay.util.httpClient.HttpProtocolHandler;
import com.comdosoft.financial.user.utils.alipay.util.httpClient.HttpRequest;
import com.comdosoft.financial.user.utils.alipay.util.httpClient.HttpResponse;
import com.comdosoft.financial.user.utils.alipay.util.httpClient.HttpResultType;
import com.comdosoft.financial.user.utils.alipay.sign.MD5;
